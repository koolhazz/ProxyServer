...
const unsigned int TblAccount_SrcType = 0x00060006;  //int8
...
const unsigned int TblBasicInfo_SrcType = 0x0007000E;  //int8
...
const unsigned int TblArticleSort_SortName = 0x000C0003;  //string128
...
const unsigned int TblAccountVerify_SrcType = 0x000E000E;  //int8
...
const unsigned int TblGrpBBSPost_Title = 0x00610004;  //string512
...
const unsigned int TblUserLevel_Integral = 0x00640003;  //int32
const unsigned int TblUserLevel_Flag = 0x00640004;  //int32
...
const unsigned int TblMblogUser_MyfollowNum = 0x00670005;  //int32
const unsigned int TblMblogUser_Ext1 = 0x00670006;  //int32
const unsigned int TblMblogUser_Ext2 = 0x00670007;  //int32
...
const unsigned int TblMblogHistory_AskStockNum = 0x00680009;  //int32
const unsigned int TblMblogHistory_CollectNum = 0x0068000a;  //int32
const unsigned int TblMblogHistory_ItemType = 0x0068000b;  //int32
const unsigned int TblMblogHistory_InfoStr = 0x0068000c;  //string1024
const unsigned int TblMblogHistory_Ext1 = 0x0068000d;  //int32
const unsigned int TblMblogHistory_Ext2 = 0x0068000e;  //int32
const unsigned int TblMblogHistory_TopicId = 0x0068000f;  //int32
...
const unsigned int TblMblogStocks_ItemType = 0x006c0005;  //int32
const unsigned int TblMblogStocks_IteminfoStr = 0x006c0006;  //string1024
const unsigned int TblMblogStocks_Ext1 = 0x006c0007;  //int32
const unsigned int TblMblogStocks_Ext2 = 0x006c0008;  //int32
...
const unsigned int TblFeedback_CategoryID = 0x00700004;  //int8
const unsigned int TblFeedback_Uin = 0x00700005;  //int32
const unsigned int TblFeedback_ReplyUin = 0x00700006;  //int32
const unsigned int TblFeedback_RemarkUin = 0x00700007;  //int32
const unsigned int TblFeedback_Reply = 0x00700008;  //string255
const unsigned int TblFeedback_Remark = 0x00700009;  //string255
const unsigned int TblFeedback_Description = 0x0070000a;  //string512
const unsigned int TblFeedback_Contact = 0x0070000a;  //string256
const unsigned int TblFeedback_PostTime = 0x0070000c;  //int32
const unsigned int TblFeedback_Status = 0x0070000d;  //int32
...
const unsigned int TblRegHis_AdvID                          = 0x00760007;    //  int32
const unsigned int TblRegHis_InternalID                     = 0x00760008;    //  int32
...
const unsigned int TblFeeds_RelatedUIN                      = 0x00770003;    //  int32
const unsigned int TblFeeds_AppId                           = 0x00770004;    //  int32
const unsigned int TblFeeds_FeedsType                       = 0x00770005;    //  int16
const unsigned int TblFeeds_SubmitTime                      = 0x00770006;    //  int32
const unsigned int TblFeeds_Content                         = 0x00770007;    //  text
const unsigned int TblFeeds_Reserved_1                      = 0x00770008;    //  string255
const unsigned int TblFeeds_Reserved_2                      = 0x00770009;    //  string255
...
const unsigned int TblMobileArea_Province                      = 0x00820002;    //  string20
const unsigned int TblMobileArea_City                          = 0x00820003;    //  string20
const unsigned int TblMobileArea_CardType                      = 0x00820004;    //  string30
const unsigned int TblMobileArea_AreaCode                      = 0x00820005;    //  string5


/**************************************************
               TblDayKLineData
**************************************************/
const unsigned int TblDayKLineDataID                        = 0x0083;

const unsigned int TblDayKLineData_StockCode                = 0x00830001;    //  string8    primary
const unsigned int TblDayKLineData_MarketType               = 0x00830002;    //  int32
const unsigned int TblDayKLineData_KLineDate                = 0x00830003;    //  string10
const unsigned int TblDayKLineData_PrevClose                = 0x00830004;    //  int32
const unsigned int TblDayKLineData_TodayOpen                = 0x00830005;    //  int32
const unsigned int TblDayKLineData_TodayHigh                = 0x00830006;    //  int32
const unsigned int TblDayKLineData_TodayLow                 = 0x00830007;    //  int32
const unsigned int TblDayKLineData_ClosePrice               = 0x00830008;    //  int32
const unsigned int TblDayKLineData_Amount                   = 0x00830009;    //  int64
const unsigned int TblDayKLineData_Volume                   = 0x0083000a;    //  int64


/**************************************************
               TblMarkToMarketData
**************************************************/
const unsigned int TblMarkToMarketDataID                    = 0x0084;

const unsigned int TblMarkToMarketData_StockCode            = 0x00840001;    //  string8    primary
const unsigned int TblMarkToMarketData_MarketType           = 0x00840002;    //  int32
const unsigned int TblMarkToMarketData_MarkPrice            = 0x00840003;    //  int32
const unsigned int TblMarkToMarketData_MarktTime            = 0x00840004;    //  int32
const unsigned int TblMarkToMarketData_Mark                 = 0x00840005;    //  int32
const unsigned int TblMarkToMarketData_MarkType             = 0x00840006;    //  int32


/**************************************************
               TblEarningsRateData
**************************************************/
const unsigned int TblEarningsRateDataID                    = 0x0085;

const unsigned int TblEarningsRateData_StockCode            = 0x00850001;    //  string8    primary
const unsigned int TblEarningsRateData_MarketType           = 0x00850002;    //  int32
const unsigned int TblEarningsRateData_MarkType             = 0x00850003;    //  int32
const unsigned int TblEarningsRateData_HighDate             = 0x00850004;    //  string10
const unsigned int TblEarningsRateData_MarkDate             = 0x00850005;    //  string10
const unsigned int TblEarningsRateData_MarkDayNum           = 0x00850006;    //  int32
const unsigned int TblEarningsRateData_TodayHigh            = 0x00850007;    //  int32
const unsigned int TblEarningsRateData_MarkPrice            = 0x00850008;    //  int32
const unsigned int TblEarningsRateData_EarningsRate         = 0x00850009;    //  int32


/**************************************************
               TblDeletedItem
**************************************************/
const unsigned int TblDeletedItemID                    = 0x0086;

const unsigned int TblDeletedItem_ID                   = 0x00860001;    //  int32
const unsigned int TblDeletedItem_ItemID               = 0x00860002;    //  int32
const unsigned int TblDeletedItem_ItemHostID           = 0x00860003;    //  int32
const unsigned int TblDeletedItem_ItemType             = 0x00860004;    //  int8
const unsigned int TblDeletedItem_Title                = 0x00860005;    //  string200
const unsigned int TblDeletedItem_Content              = 0x00860006;    //  text
const unsigned int TblDeletedItem_Uin                  = 0x00860007;    //  int32
const unsigned int TblDeletedItem_AnalystUin           = 0x00860008;    //  int32
const unsigned int TblDeletedItem_AdminUin             = 0x00860009;    //  int32
const unsigned int TblDeletedItem_Remark               = 0x0086000a;    //  string255
const unsigned int TblDeletedItem_DelTime              = 0x0086000b;    //  int32


/**************************************************
               TblSpecialInfo
**************************************************/
const unsigned int TblSpecialInfoID                    = 0x0087;

const unsigned int TblSpecialInfo_Id                   = 0x00870001;    //  int32
const unsigned int TblSpecialInfo_Type                 = 0x00870002;    //  int32
const unsigned int TblSpecialInfo_Content              = 0x00870003;    //  text
const unsigned int TblSpecialInfo_ModifyTime           = 0x00870004;    //  int32


/**************************************************
               TblOnlineInfo
**************************************************/
const unsigned int TblOnlineInfoID                     = 0x0088;

const unsigned int TblOnlineInfo_ID                    = 0x00880001;    //  int32
const unsigned int TblOnlineInfo_Num                   = 0x00880002;    //  int32
const unsigned int TblOnlineInfo_Cur_time              = 0x00880003;    //  int32


/**************************************************
               TblMblogCFA
**************************************************/
const unsigned int TblMblogCFAID                     = 0x0089;

const unsigned int TblMblogCFA_UIN                   = 0x00890001;    //  int32
const unsigned int TblMblogCFA_Status                = 0x00890002;    //  int32
const unsigned int TblMblogCFA_Rank                  = 0x00890003;    //  int32
const unsigned int TblMblogCFA_Level                 = 0x00890004;    //  int32
const unsigned int TblMblogCFA_Description           = 0x00890005;    //  text


/**************************************************
               TblDailyStat
**************************************************/
const unsigned int TblDailyStatID                     = 0x008a;

const unsigned int TblDailyStat_Seq                   = 0x008a0001;    //  int32
const unsigned int TblDailyStat_Time                  = 0x008a0002;    //  int32
const unsigned int TblDailyStat_Type                  = 0x008a0003;    //  int32
const unsigned int TblDailyStat_SubType               = 0x008a0004;    //  int32
const unsigned int TblDailyStat_Value                 = 0x008a0005;    //  int64
...
/**************************************************
               TblCrashInfo
**************************************************/
const unsigned int TblCrashInfoID                     = 0x008b;

const unsigned int TblCrashInfo_CrashSig              = 0x008b0001;    //  string64
const unsigned int TblCrashInfo_UIN                   = 0x008b0002;    //  int32
const unsigned int TblCrashInfo_LCID                  = 0x008b0003;    //  int32
const unsigned int TblCrashInfo_AppName               = 0x008b0004;    //  string128
const unsigned int TblCrashInfo_AppVer                = 0x008b0005;    //  int64
const unsigned int TblCrashInfo_OSID                  = 0x008b0006;    //  int32
const unsigned int TblCrashInfo_OSMajVer              = 0x008b0007;    //  int32
const unsigned int TblCrashInfo_OSMinVer              = 0x008b0008;    //  int32
const unsigned int TblCrashInfo_OSBuildNo             = 0x008b0009;    //  int32
const unsigned int TblCrashInfo_ErrAddr               = 0x008b000a;    //  int32
const unsigned int TblCrashInfo_CrashTime             = 0x008b000b;    //  int32
const unsigned int TblCrashInfo_UserDesc              = 0x008b000c;    //  string512
const unsigned int TblCrashInfo_Contact               = 0x008b000d;    //  string128
const unsigned int TblCrashInfo_Account               = 0x008b000e;    //  string128
const unsigned int TblCrashInfo_DETAIL1               = 0x008b000f;    //  string128
const unsigned int TblCrashInfo_DETAIL2               = 0x008b0010;    //  string128
const unsigned int TblCrashInfo_CrashFlag             = 0x008b0011;    //  string32
...
/**************************************************
               TblMblogAnalysis
**************************************************/
const unsigned int TblMblogAnalysisID                   = 0x008c;

const unsigned int TblMblogAnalysis_StockIndex          = 0x008c0001;   //  int32 
const unsigned int TblMblogAnalysis_CommentNum          = 0x008c0002;   //  int32
const unsigned int TblMblogAnalysis_ExpertCommNum       = 0x008c0003;   //  int32
const unsigned int TblMblogAnalysis_Ext1                = 0x008c0004;   //  int32
const unsigned int TblMblogAnalysis_Ext2                = 0x008c0005;   //  int32
const unsigned int TblMblogAnalysis_Ext3                = 0x008c0006;   //  int32
const unsigned int TblMblogAnalysis_Ext4                = 0x008c0007;   //  int32
const unsigned int TblMblogAnalysis_Ext5                = 0x008c0008;   //  int32
const unsigned int TblMblogAnalysis_Ext6                = 0x008c0009;   //  int32
const unsigned int TblMblogAnalysis_Ext7                = 0x008c000a;   //  int32
const unsigned int TblMblogAnalysis_Ext8                = 0x008c000b;   //  int32
const unsigned int TblMblogAnalysis_Ext9                = 0x008c000c;   //  int32
const unsigned int TblMblogAnalysis_Ext10               = 0x008c000d;   //  int32

/**************************************************
               TblMblogVote
**************************************************/
const unsigned int TblMblogVoteID                       = 0x008d;

const unsigned int TblMblogVote_StockIndex              = 0x008d0001;   //  int32
const unsigned int TblMblogVote_Option_1                = 0x008d0002;   //  int32
const unsigned int TblMblogVote_Option_2                = 0x008d0003;   //  int32
const unsigned int TblMblogVote_Option_3                = 0x008d0004;   //  int32
const unsigned int TblMblogVote_TimeStamp               = 0x008d0005;   //  int32
const unsigned int TblMblogVote_Ext1                    = 0x008d0006;   //  int32
const unsigned int TblMblogVote_Ext2                    = 0x008d0007;   //  int32
const unsigned int TblMblogVote_Ext3                    = 0x008d0008;   //  int32
const unsigned int TblMblogVote_Ext4                    = 0x008d0009;   //  int32
const unsigned int TblMblogVote_Ext5                    = 0x008d000a;   //  int32


/**************************************************
               TblTipsSetting
**************************************************/
const unsigned int TblTipsSettingID                       = 0x008e;

const unsigned int TblTipsSetting_UIN                     = 0x008e0001;   //  int32
const unsigned int TblTipsSetting_TipsId                  = 0x008e0002;   //  int32
const unsigned int TblTipsSetting_Value                   = 0x008e0003;   //  int8


/**************************************************
               TblHotKeyWords  
**************************************************/
const unsigned int TblHotKeyWordsID                       = 0x008f;

const unsigned int TblHotKeyWords_HotKeyWord              = 0x008f0001;   //  int32
const unsigned int TblHotKeyWords_HotCount                = 0x008f0002;   //  int32


/**************************************************
               TblGrpRecommended  
**************************************************/
const unsigned int TblGrpRecommendedID                     = 0x0091;

const unsigned int TblGrpRecommended_GroupUIN              = 0x00910001;   //  int32
const unsigned int TblGrpRecommended_Type                  = 0x00910002;   //  int32


/**************************************************
               TblMbMobile  
**************************************************/
const unsigned int TblMbMobileID                           = 0x0092;

const unsigned int TblMbMobile_ItemID                      = 0x00920001;   //int64
const unsigned int TblMbMobile_UIN                         = 0x00920002;   //int32
const unsigned int TblMbMobile_RelationUIN                 = 0x00920003;   //int32
const unsigned int TblMbMobile_ParentID                    = 0x00920004;   //int64
const unsigned int TblMbMobile_Content                     = 0x00920005;   //text
const unsigned int TblMbMobile_MobileNO                    = 0x00920006;   //string20
const unsigned int TblMbMobile_Ext1                        = 0x00920007;   //int32
const unsigned int TblMbMobile_Ext2                        = 0x00920008;   //int32
const unsigned int TblMbMobile_Ext3                        = 0x00920009;   //string1024


/**************************************************
               TblMbTrace  
**************************************************/
const unsigned int TblMbTraceID                            = 0x0093;

const unsigned int TblMbTrace_UIN                          = 0x00930001;   //int32
const unsigned int TblMbTrace_StockInfo                    = 0x00930002;   //text
const unsigned int TblMbTrace_Ext1                         = 0x00930003;   //int32
const unsigned int TblMbTrace_Ext2                         = 0x00930004;   //int32
const unsigned int TblMbTrace_Ext3                         = 0x00930005;   //int32


/**************************************************
               TblGrpHotspot  
**************************************************/
const unsigned int TblGrpHotspotID                          = 0x0094;

const unsigned int TblGrpHotspot_GrpUIN                     = 0x00940001;  //int32
const unsigned int TblGrpHotspot_TopicID                    = 0x00940002;  //int64
const unsigned int TblGrpHotspot_Time                       = 0x00940003;  //int32
const unsigned int TblGrpHotspot_Type                       = 0x00940004;  //int32


/**************************************************
               TblFilterKey
**************************************************/
const unsigned int TblFilterKeyID                          = 0x0095;

const unsigned int TblFilterKey_ID                         = 0x00950001; //int32
const unsigned int TblFilterKey_FilterKey                  = 0x00950002; //string512
const unsigned int TblFilterKey_Type                       = 0x00950003; //int32
const unsigned int TblFilterKey_Status                     = 0x00950004; //int16


/**************************************************
               TblFilterLog
**************************************************/
const unsigned int TblFilterLogID                          = 0x0096;
 
const unsigned int TblFilterLog_From_uin                   = 0x00960001; //int32
const unsigned int TblFilterLog_FilterKey                  = 0x00960002; //string512
const unsigned int TblFilterLog_Msg                        = 0x00960003; //binary
const unsigned int TblFilterLog_Msg_type                   = 0x00960004; //int32
const unsigned int TblFilterLog_Msg_time                   = 0x00960005; //int32

/**************************************************
               TblStkPoint
**************************************************/
const unsigned int TblStkPointID                          = 0x0097;

const unsigned int TblStkPoint_Uin                        = 0x00970001; //int32
const unsigned int TblStkPoint_StkPoint                   = 0x00970002; //binary
...
/**************************************************
               TblMblogTopicInfo
**************************************************/
const unsigned int TblMblogTopicInfoID                  = 0x0098;

const unsigned int TblMblogTopicInfo_TopicID            = 0x00980001; //int32
const unsigned int TblMblogTopicInfo_TopicName          = 0x00980002; //string512
const unsigned int TblMblogTopicInfo_TopicNum           = 0x00980003; //int32
const unsigned int TblMblogTopicInfo_Status             = 0x00980004; //int32
const unsigned int TblMblogTopicInfo_PostTime           = 0x00980005; //int32
const unsigned int TblMblogTopicInfo_Ext1               = 0x00980006; //int32
const unsigned int TblMblogTopicInfo_Ext2               = 0x00980007; //int32
const unsigned int TblMblogTopicInfo_Ext3               = 0x00980008; //int32


/**************************************************
               TblMblogTopicInfoContent
**************************************************/
const unsigned int TblMblogTopicInfoContentID           = 0x0099;

const unsigned int TblMblogTopicInfoContent_TopicID     = 0x00990001; //int32
const unsigned int TblMblogTopicInfoContent_ItemID      = 0x00990002; //int64
const unsigned int TblMblogTopicInfoContent_UIN         = 0x00990003; //int32
const unsigned int TblMblogTopicInfoContent_PostTime    = 0x00990004; //int32
const unsigned int TblMblogTopicInfoContent_IsAnalyse   = 0x00990005; //int32
const unsigned int TblMblogTopicInfoContent_Status      = 0x00990006; //int32
const unsigned int TblMblogTopicInfoContent_Ext1        = 0x00990007; //int32
const unsigned int TblMblogTopicInfoContent_Ext2        = 0x00990008; //int32
const unsigned int TblMblogTopicInfoContent_Ext3        = 0x00990009; //int32
...
/**************************************************
               TblProductInfo
**************************************************/
const unsigned int TblProductInfoID                     = 0x009a;

const unsigned int TblProductInfo_ID                    = 0x009a0001; //int8
const unsigned int TblProductInfo_Name                  = 0x009a0002; //string128


/**************************************************
               TblWhiteList
**************************************************/
const unsigned int TblWhiteListID                       = 0x009b;

const unsigned int TblWhiteList_Uin                     = 0x009b0001; //int32
const unsigned int TblWhiteList_Flag                    = 0x009b0002; //int32
